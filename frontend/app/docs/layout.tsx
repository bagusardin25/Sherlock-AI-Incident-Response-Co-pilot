...
import { Terminal, BookOpen, Layers, Zap, Shield, HelpCircle, ArrowLeft } from 'lucide-react'
          ...
          <nav className="space-y-8 pr-4">
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li><Link href="#quickstart" className="flex items-center gap-3 text-sm text-slate-300 hover:text-primary hover:bg-primary/5 px-3 py-2 rounded-lg transition-colors"><Zap className="w-4 h-4" /> Quickstart</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="text-xs font-semibold text-primary uppercase tracking-wider mb-3">Architecture</h4>
              <ul className="space-y-1">
                <li><Link href="#how-it-works" className="flex items-center gap-3 text-sm text-slate-300 hover:text-primary hover:bg-primary/5 px-3 py-2 rounded-lg transition-colors"><Layers className="w-4 h-4" /> How it Works</Link></li>
             ...
             <div>
              <h4 className="text-xs font-semibold text-primary uppercase tracking-wider mb-3">Resources</h4>
              <ul className="space-y-1">
